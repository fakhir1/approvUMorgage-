...
function NewRateFormContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.message || 'Failed to create rate');
    }
  };
    ...
    <div className="p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Create New Rate</h1>
          <p className="text-gray-600 mt-1">Add a new mortgage rate</p>
        </div>
          ...
          {createMutation.isError && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <p className="text-red-800 text-sm">
                {(createMutation.error as Error)?.message || 'Failed to create rate'}
              </p>
            </div>
          )}
        </form>
